...
import { CalendarCheck, ChevronLeft, ChevronRight, AlertTriangle, User } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 bg-blue-50 border border-blue-200 rounded-2xl p-4">
        ...
        <div>
          <p className="font-bold text-gray-900">{studentRecord.name}'s Attendance</p>
          <p className="text-xs text-gray-500">Student Code: <span className="font-mono font-bold text-[#1E3A8A]">{studentRecord.student_code}</span></p>
        </div>
      </div>

      <div>
        <h1 className="text-2xl font-bold text-gray-900">Child's Attendance Calendar</h1>
        <p className="text-sm text-gray-500">Track your child's daily attendance, presence rates, and holidays</p>
      </div>
