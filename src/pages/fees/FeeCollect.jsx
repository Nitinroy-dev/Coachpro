      ...
      {showUpiQrModal && (
        ...
        >
          <div className="text-center p-4 space-y-4">
            ...
            <p className="text-[10px] text-gray-500 italic">Have the student scan this QR code using BHIM, GPay, PhonePe, Paytm, or any banking app. Once they complete the transfer, click "Confirm Payment Done" to print their receipt.</p>
          </div>
        </Modal>
      )}
    </>
